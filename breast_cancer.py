...
def initial_param(data, data_2d):
    ...
    FBBMM_2d_param = np.array([[72.70908874, 33.55169584, 96.31404346, 93.07893295],
                   [ 7.6994928 , 59.44490575, 64.59623469, 78.10729486]])
    ...
    param = [(data, {'n_clusters': 2, 'quantile': .242, 'eps': .011, 'linkage': "complete", 
            ...
            (data_2d, {'n_clusters': 2, 'quantile': .214, 'eps': .031, 'linkage': "complete", 
                       'affinity': "cosine", 'MBMM_param': MBMM_2d_param, 'FBBMM_param':FBBMM_2d_param})]
